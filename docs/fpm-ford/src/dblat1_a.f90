...
!     .. Local Scalars ..
      DOUBLE PRECISION  SA
      INTEGER           I, J, KI, KN, KNI, KPAR, KSIZE, LENX, LENY, LINCX, LINCY, MX, MY
!     .. Local Arrays ..
     ...
     &                  DT19YC(7,4,4), DT19YD(7,4,4), DTEMP(5), STY0(1), SX0(1), SY0(1) 
...
!     .. Data statements ..
     ...
     &   (DT19Y(1,1,13),DT19YD(1,1,1))
      ...
      DATA              DT7/0.0D0, 0.30D0, 0.21D0, 0.62D0, 0.0D0, 0.30D0, -0.07D0, &
     & 0.85D0, 0.0D0, 0.30D0, -0.79D0, -0.74D0, 0.0D0, 0.30D0, 0.33D0, 1.27D0/
...
!     .. Local Arrays ..
     ...
     &                  MWPY(5), SSIZE2(14,2), STX(7), STY(7), SX(7), SY(7)
      INTEGER           INCXS(4), INCYS(4), LENS(4,2), MWPINX(11), MWPINY(11), MWPN(11), NS(4)
!     .. External Subroutines ..
!     .. Intrinsic Functions ..
      INTRINSIC         ABS, MIN
!     .. Common blocks ..
