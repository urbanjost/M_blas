...
!     .. Executable Statements ..
      ...
      open(unit=nin,file='test/dblat3.in')
!
...
!     the result computed by DMMCH.
      TRANSA = 'N'
      TRANSB = 'N'
      CALL DMMCH( TRANSA, TRANSB, N, 1, N, ONE, AB, NMAX, AB( 1, NMAX + 1 ), NMAX, ZERO, C, NMAX, CT, G, CC, &
...
!
 ...
 9995 FORMAT( ' TESTS OF THE DOUBLE PRECISION LEVEL 3 BLAS', //' THE F', 'OLLOWING PARAMETER VALUES WILL BE USED:' )
 ...
 9990 FORMAT( ' SUBPROGRAM NAME ', A6, ' NOT RECOGNIZED', /' ******* TESTS ABANDONED *******' )
...
!
                           ...
                           IF( REWI ) REWIND NTRA
                           CALL DGEMM( TRANSA, TRANSB, M, N, K, ALPHA, AA, LDA, BB, LDB, BETA, CC, LDC )
!
...
!                             Check the result.
!
                              CALL DMMCH( TRANSA, TRANSB, M, N, K, ALPHA, A, NMAX, B, NMAX, BETA, C, NMAX, CT, G, CC, LDC, EPS, &
     &                                    ERR, FATAL, NOUT, .TRUE. )
...
!
     ...
     &                           LDA, LDB
                           ...
                           ELSE IF( SNAME( 4: 5 ).EQ.'SM' )THEN
                              IF( TRACE ) &
     &                           WRITE( NTRA, FMT = 9995 )NC, SNAME, SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, LDA, LDB
                              IF( REWI ) REWIND NTRA
...
!
      ...
      use M_blas, only : DGEMM, DSYMM, DSYR2K, DSYRK, DTRMM, DTRSM
!
